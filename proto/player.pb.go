...
const file_proto_player_proto_rawDesc = "" +
	...
	"\aplayers\x18\x01 \x03(\v2\x0e.player.PlayerR\aplayers2Q\n" +
	"\rPlayerService\x12@\n" +
	"\tGetPlayer\x12\x18.player.GetPlayerRequest\x1a\x19.player.GetPlayerResponseB,Z*getswing.app/player-service/proto;playerpbb\x06proto3"
...
var file_proto_player_proto_goTypes = []any{
	...
	(*GetPlayerResponse)(nil), // 2: player.GetPlayerResponse
}
var file_proto_player_proto_depIdxs = []int32{
	1, // 0: player.GetPlayerResponse.players:type_name -> player.Player
	0, // 1: player.PlayerService.GetPlayer:input_type -> player.GetPlayerRequest
	2, // 2: player.PlayerService.GetPlayer:output_type -> player.GetPlayerResponse
